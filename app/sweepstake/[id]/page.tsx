          ...
          <div>
            {!me ? (
              ...
              <div className="space-y-4">
                ...
                {sw.fixtures.filter((f) => !f.played && (me.teams.includes(f.teamA) || me.teams.includes(f.teamB))).slice(0, 5).map((f) => {
            ...
            <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
              ...
              <div className="space-y-1 text-sm">
                {[["Win", POINTS_SYSTEM.groupWin], ["Draw", POINTS_SYSTEM.groupDraw], ["Loss", POINTS_SYSTEM.groupLoss],
                  ...
                  ["Semi Final", POINTS_SYSTEM.semiFinal], ["Runner Up", POINTS_SYSTEM.runnerUp], ["Winner 🏆", POINTS_SYSTEM.winner]
                ].map(([label, pts]) => (
